...
type Status struct {
	...
	// Notify - будить ли автора сообщением при переходе в этот статус. Правится
	// файлом правил: состав будящих событий меняется без миграции и без выката.
	// Отсутствие поля значит «не будит».
